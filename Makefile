...
clean: ## Очистить сгенерированные файлы и артефакты
	@echo "🧹 Очистка..."
	@rm -rf bin/
...
clean-skeleton: ## Очистить скелетон от временных API файлов
...
lint-fix: ## Запустить линтер с автофиксом
	@echo "🔧 Запуск линтера с автофиксом..."
	@golangci-lint run --fix ./...
	@echo "✅ Автофикс завершен"
